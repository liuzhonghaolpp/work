...
<body>
	 <div class="newgoods">
	 	<form class="form-horizontal" action="${basePath}/Products/add.do" method="post" enctype="multipart/form-data">
    <fieldset>
      <div id="legend" class="">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="请输入商品名称" class="input-xlarge" name="name">
     ...
     <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="请输入商品类型" class="input-xlarge" name="type">
            <p class="help-block"></p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="请输入价格" class="input-xlarge" name="price">
            <p class="help-block"></p>
          </div>
          ...
          <div class="controls">
            <input type="text" placeholder="请输入现有库存量" class="input-xlarge" name="instock">
            <p class="help-block"></p>
          </div>
        </div><div class="control-group">
